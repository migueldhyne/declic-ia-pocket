...
import {Divider, Drawer, Text, Icon} from 'react-native-paper';
      ...
      () => (
        <View>
          <Drawer.Section showDivider={false}>
            ...
            />
            {/* Base documentaire — bibliothèque de documents partagés (RAG) */}
            <Drawer.Item
              label="Base documentaire"
              icon={() => (
                <Icon
                  source="folder-multiple-outline"
                  size={24}
                  color={theme.colors.primary}
                />
              )}
              onPress={() => props.navigation.navigate(ROUTES.RAG_LIBRARY)}
              style={styles.menuDrawerItem}
              testID="drawer-item-rag-library"
            />
            <Drawer.Item
