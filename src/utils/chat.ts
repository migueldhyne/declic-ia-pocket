...
export const chatTemplates: Record<string, ChatTemplateConfig> = {
  ...
  danube3: {
    ...
    addGenerationPrompt: true,
    systemPrompt:
      'Tu es Déclic IA, un assistant conversationnel créé par GenerationDeclic.net. Tu réponds en français, de manière précise, concise et bienveillante.',
  },
  danube2: {
    ...Templates.templates.danube2,
    name: 'danube2',
  ...
  qwen2: {
    ...
    name: 'qwen2',
    addGenerationPrompt: true,
    systemPrompt: 'Tu es Déclic IA, un assistant conversationnel créé par GenerationDeclic.net. Tu réponds en français.',
  },
  qwen25: {
